...
const makeThree = () => {
  ...
  resultThree.textContent = product;
};
...
const makeFour = () => {
  ...
  resultFour.textContent = dividing;
};
...
const makeSix = () => {
  ...
  const num2 = 5;
  const dividing = num1 / num2;
  resultSix.textContent = dividing;
};
...
const makeSeven = () => {
  ...
  resultSeven.textContent = remainder;
};
...
const makeEight = () => {
  ...
  resultEight.textContent = remainder;
};
...
const makeNine = () => {
  const num1 = 4567;
  const remainder = num1 % 100;
  resultNine.textContent = remainder;
};
...
const makeThirteen = () => {
  ...
  resultThirteen.textContent = lengthStr;
};
...
const makeTwentySeven = () => {
  const result = Math.floor(Math.random() * 50) + 50;
